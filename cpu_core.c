...
byte* compute_addr_mode_g1(CPU_t* cpu) //Calculates the address based on the addresation mode
{
...
{
    /*
    TODO: Implement the first group of instructions(shouldn't be that hard)
    ...
    */
    ...
    {
        case 0x01: //cc = 01
            address = compute_addr_mode_g1(cpu);
